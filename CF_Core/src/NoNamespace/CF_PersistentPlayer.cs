public class CF_PersistentPlayer
{
    public static bool IsFriendOf(PersistentPlayerData ppd, int entityId)
    {
        ...
        PersistentPlayerData _ppd2 = CF_Player.GetPersistentPlayerData(entityId);
        if (_ppd2 == null)
        {
    ...
    {
        PersistentPlayerData ppd1 = CF_Player.GetPersistentPlayerData(_UserId1);
        if (ppd1 == null)
        {
        ...
        PersistentPlayerData _ppd2 = CF_Player.GetPersistentPlayerData(_UserId2);
        if (_ppd2 == null)
        {
    ...
    public static bool IsFriendOf(PersistentPlayerData ppd, PlatformUserIdentifierAbs _UserId)
    {
        ...
        PersistentPlayerData _ppd2 = CF_Player.GetPersistentPlayerData(_UserId);
        if (_ppd2 == null)
        {
